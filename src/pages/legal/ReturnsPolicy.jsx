    ...
    return (
        <LegalPageLayout title="Returns & Refunds" lastUpdated="May 2026">
            ...
            <ol>
                ...
                <li>In case of any refunds approved by JGM INDUSTRIES, Refund will be credited to your original payment method with in 5 days.</li>
            </ol>

            <h2>Return Policy</h2>
            <p>Return will be acceptable with in 7 days. Exchange and replacement will delivered with in 7 days. If 7 days have passed since your purchase, you will not be offered a return, exchange or refund of any kind. In order to become eligible for a return or an exchange, (i) the purchased item should be unused and in the same condition as you received it, (ii) the item must have original packaging, (iii) if the item that you purchased on a sale, then the item may not be eligible for a return / exchange. Further, only such items are replaced by us (based on an exchange request), if such items are found defective or damaged.</p>
