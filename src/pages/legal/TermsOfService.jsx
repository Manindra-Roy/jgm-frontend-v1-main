...
export default function TermsOfService() {
    return (
        <LegalPageLayout title="Terms & Conditions" lastUpdated="May 2026">
            ...
            <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.jgmindustries.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>

            <p>The Platform is owned by JGM INDUSTRIES, a company incorporated under the Companies Act, 1956 with its registered office at LEUSIPAKURI, siliguri darjeeling -734434 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
            ...
            <ol>
                ...
                <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Siliguri and Darjeeling.</li>
